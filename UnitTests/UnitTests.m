...
-(void)testAddPatientSimple {
    [DBTalk addPatient:@"Jeremy" middleName:@"peabody" lastName:@"Clarkson" birthday:@"20040808"];
    [DBTalk addUpdatePatient:@"Beau" middleName:@"John" lastName:@"Jones" birthday:@"19840101" patientId:@"NULL"];
